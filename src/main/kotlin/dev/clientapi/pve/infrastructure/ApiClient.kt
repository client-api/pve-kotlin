package dev.clientapi.pve.infrastructure
...
open class ApiClient(val baseUrl: String, val client: Call.Factory = defaultClient) {
    companion object {
        ...
        const val BASE_URL_KEY: String = "dev.clientapi.pve.baseUrl"
        @Deprecated(
    ...
    protected fun <T> updateAuthParams(requestConfig: RequestConfig<T>) {
            if (apiKey["PVEAuthCookie"] != null) {
                if (apiKeyPrefix["PVEAuthCookie"] != null) {
                } else {
                }
            }
